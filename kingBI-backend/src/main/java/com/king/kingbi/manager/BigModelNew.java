...
public class BigModelNew extends WebSocketListener {
    ...
    public static final String appid = "b670957b";
    public static final String apiSecret = "ZTdlZmNkZGI0NDUzYjRlMzYzZTFlMTYx";
    public static final String apiKey = "cae6df345928cc62f7b91d08fa5d738f";
...
//              for (int i = 0; i < 1; i++) {
//                  totalAnswer="";
//                  WebSocket webSocket = client.newWebSocket(request, new BigModelNew(i + "1",
//                          false));
//              }
//          }else{
//              Thread.sleep(200);
